...
glm_sLL2<-glmer(sLL~Temp_fac*State+(1|Family), family=gaussian(link="log"), data=adult)
summary(glht(glm_sLL2, mcp(Temp_fac="Tukey")))
summary(glht(glm_sLL2, mcp(Temp_fac="Tukey", State="Tukey")))
